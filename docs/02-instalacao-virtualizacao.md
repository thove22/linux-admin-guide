...
### O Conceito de Virtual na Computação
A palavra "virtual" expandiu o seu significado com o crescimento da Internet. Hoje, interagimos com lojas, visitas e bibliotecas virtuais. Na computação, a virtualização refere-se frequentemente à abstração de um componente físico num objeto lógico, permitindo extrair uma maior utilidade desse recurso. Exemplos comuns incluem:
